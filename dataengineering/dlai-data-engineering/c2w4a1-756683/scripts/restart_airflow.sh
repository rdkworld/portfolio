...
export airflow_instance_public_ip=$(aws ec2 describe-instances --filters 'Name=tag:Name,Values=de-c2w4a1-airflow-instance' --query "Reservations[].Instances[].PublicIpAddress" --output text)
