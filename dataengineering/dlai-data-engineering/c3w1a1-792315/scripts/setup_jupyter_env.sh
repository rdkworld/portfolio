...
export sg_modification_status=$(aws ec2 authorize-security-group-ingress --group-id $security_group_id --protocol tcp --port 7687 --cidr 0.0.0.0/0 --query 'Return' --output text)
